...
import { X, CheckCircle2, Clock, AlertCircle, Calendar, User, Briefcase } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      >
        ...
        <div className="px-6 py-3 bg-white/[0.03] border-b border-white/5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span className="text-xs font-semibold text-[#8e9299]">অগ্রগতি:</span>
            <span
          ...
          <span className="text-xs text-[#8e9299]">
            {doneCount} সম্পন্ন • {totalCount - doneCount} পেন্ডিং
          </span>
        </div>
            ...
            return (
              ...
              >
                  ...
                  <div className="min-w-0">
                    ...
                    {!isDone && item.reason_for_pending && (
                      <div className="mt-1 flex items-start gap-1.5 text-xs text-amber-300/90 italic bg-amber-500/10 px-2.5 py-1 rounded border border-amber-500/20">
                        ...
                        <span>কারণ: "{item.reason_for_pending}"</span>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="shrink-0 flex items-center justify-end">
                  ...
                  >
                    {isDone ? 'সম্পন্ন (Done)' : 'পেন্ডিং (Pending)'}
                  </span>
                </div>
              </div>
            );
